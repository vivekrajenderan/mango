...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2020 at 03:06 PM
...
(5, 'CUSTOMER5', 'Name', '2020-07-08', 'male', 'ghjghjgjhghj', '3333333333', 's@s.in', 'Occupation', '2222222.00', '2222222222222', '333333333', '', '1596113248-aadhardocument.jpeg', NULL, '1596113248-profile.png', NULL, 1, '1', '0', NULL, 1596113978);
...
(1, 'customer', 'CUSTOMER', 0, 6, '1', 0, '0', 1554959938, 1596113248),
...
INSERT INTO `financeloan` (`id`, `loanreferenceno`, `fk_customer_id`, `fk_employee_id`, `fk_vechicle_id`, `requestdate`, `approveddate`, `activateddate`, `originalloanamount`, `totalemiamount`, `commission`, `loanperiod`, `loanperiodfrequency`, `loanintrestrate`, `security1name`, `security1aadhar`, `security1mobileno`, `security1profile`, `security2name`, `security2aadhar`, `security2mobileno`, `nextduedate`, `loanstatus`, `approveddocument`, `cheasedreason`, `createdby`, `updatedby`, `status`, `dels`, `cdate`, `mdate`, `emiamount`, `lastduedate`, `payment_count`, `late_payment_count`, `document_charge`, `agent_charge`) VALUES
(1, '1', 5, 1, 4, '2020-07-29', NULL, NULL, '20000.00', '0.00', '4.00', 15, 'month', '0.00', '4fdg', '64564564', '5455555555', '1596113248-security1profile.jpeg', '', '', '', NULL, 'pending', NULL, NULL, 1, 1, '1', '0', 1596113248, 1596113979, '1500.00', NULL, 0, 0, '100.00', '800.00');
...
(4, 5, '123', 'Vehicle', '2024', 'Model', 'RC 34534', 'Insurance f344444', '2020-07-31', '2020-07-01', 'Engine', '1596113248-rcdocument.png', NULL, 0, NULL, NULL, 1, 1, '1', '0', 1596113248, 1596113979);

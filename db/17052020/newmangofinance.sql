...
INSERT INTO `financeemployee` (`id`, `fk_users_id`, `empno`, `empname`, `dob`, `emplsex`, `fk_employeestatus_id`, `position`, `salary`, `address`, `phone`, `email`, `empin`, `empout`, `empl_lastupd`, `profileimage`, `status`, `dels`, `cdate`, `mdate`) VALUES
(1, 1, 'EMPLOYEE1003', 'vvjfjfq', '2020-01-04', 'male', 1, '', '43454.58000', 'jhg jkggk k g', '9999999999', '', '2020-04-18 22:41:39', NULL, NULL, '1587229899-profileimage.jpg', '0', '0', 0, 0),
...
--
-- Table structure for table `financeemployeestatus`
--

CREATE TABLE `financeemployeestatus` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `financeemployeestatus`
--

INSERT INTO `financeemployeestatus` (`id`, `statusname`, `status`, `dels`) VALUES
(1, 'Single', '1', '0'),
(2, 'Married', '1', '0'),
(3, 'Widowed', '1', '0'),
(4, 'Divorced', '1', '0');
...
CREATE TABLE `financeloan` (
  ...
  `loanstatus` enum('pending','approved','cleared','vechile_cheased') DEFAULT NULL,
...
INSERT INTO `financeusers` (`id`, `fullname`, `fk_employee_id`, `username`, `password`, `fk_usergroups_id`, `status`, `pwdresetdate`, `dels`, `cdate`, `mdate`, `devicetoken`) VALUES
...
--
-- Indexes for table `financeemployeestatus`
--
ALTER TABLE `financeemployeestatus`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `financeemployeestatus`
--
ALTER TABLE `financeemployeestatus`

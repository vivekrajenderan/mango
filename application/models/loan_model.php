...
class Loan_model extends CI_Model {
    ...
    public function getLoan($params = array()) {
        $this->db->select('l.*,c.cusname,c.cusmobileno,c.cusaddress,v.vechilenumber,v.vechilename,v.vechilemodelyear,v.vechilemanufectureyear,v.vechilechessisno,v.vechileinsurenceno,v.vechileinsurensestartdate,v.vechileinsurenseduedate,'

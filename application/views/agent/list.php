                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        ...
                        <div class="portlet-header">
                            ...
                            <a href="<?php echo base_url('agent/add'); ?>" class="btn btn-secondary pull-right">Add Agent</a>
                        ...
                        <div class="portlet-content">           
                            ...
                            <div class="table-responsive">                                
                                <table 
                                    ...
                                    <thead>
                                        <tr>                                            
                                            <th data-filterable="true" data-sortable="true" data-direction="desc">Agent No.</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($list as $key => $value) { ?>
                                            <tr>                                           
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="javascript:void(0);" class="btn btn-default btn-sm agentview" data-id="<?php echo (isset($value->ecodeid)) ? $value->ecodeid : 0; ?>"><i class="fa fa-eye"></i></a>
                                                        <a href="<?php echo base_url('agent/add/' . $value->ecodeid); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm agentdelete" data-id="<?php echo (isset($value->ecodeid)) ? $value->ecodeid : 0; ?>"><i class="fa fa-times"></i></a>                                                   
                                                    </div>
                                            </tr>                                             
                                        <?php } ?>
                                    </tbody>

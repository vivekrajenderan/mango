                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        ...
                        <div class="portlet-content">
                            <form  class="form parsley-form" method="post" autocomplete="off" id="loan-view-form" action="<?php echo base_url() . 'loan/save'; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input type="text" id="loanreferenceno" name="loanreferenceno" class="form-control col-md-7 col-xs-12" maxlength="30" disabled value="<?php echo (isset($list->loanreferenceno)) ? $list->loanreferenceno : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input type="text" id="cusname" name="cusname" class="form-control col-md-7 col-xs-12" maxlength="50" minlength="3" disabled value="<?php echo (isset($customerlist->cusname)) ? $customerlist->cusname : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <select disabled id="cussex" name="cussex" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                                                    <input id="cusdob" name="cusdob" class="form-control" type="text" data-required="true" value="<?php echo (isset($customerlist->cusdob)) ? $customerlist->cusdob : ""; ?>" disabled>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="occup" name="occup" class="form-control col-md-7 col-xs-12" maxlength="100" minlength="3" value="<?php echo (isset($customerlist->occup)) ? $customerlist->occup : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="aadhar" name="aadhar" class="form-control col-md-7 col-xs-12 allownumericwithdecimal" maxlength="30" minlength="3" value="<?php echo (isset($customerlist->aadhar) && !empty($customerlist->aadhar)) ? number_format($customerlist->aadhar, 2, '.', '') : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="cusmobileno" name="cusmobileno" class="form-control col-md-7 col-xs-12" maxlength="10" minlength="10" value="<?php echo (isset($customerlist->cusmobileno)) ? $customerlist->cusmobileno : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="cusemail" name="cusemail" class="form-control col-md-7 col-xs-12" maxlength="30" minlength="3" value="<?php echo (isset($customerlist->cusemail)) ? $customerlist->cusemail : ""; ?>">
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="pan" name="pan" class="form-control col-md-7 col-xs-12" maxlength="100" minlength="3" value="<?php echo (isset($customerlist->pan)) ? $customerlist->pan : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="drivinglicence" name="drivinglicence" class="form-control col-md-7 col-xs-12" maxlength="100" minlength="3" value="<?php echo (isset($customerlist->drivinglicence)) ? $customerlist->drivinglicence : ""; ?>">
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="row">                                     
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <textarea disabled  data-required="true" data-minlength="10" name="cusaddress" id="cusaddress" cols="10" rows="2" class="form-control"><?php echo (isset($customerlist->cusaddress)) ? $customerlist->cusaddress : ""; ?></textarea>
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal"> 
                                                ...
                                                <div class="input-group image-preview" id="customer_profile_image_content" style="padding-left: 5px;display:<?php echo $profiledisplay; ?>;">
                                                    <input disabled type="text" class="form-control image-preview-filename" disabled="disabled">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <select id="regioncolor" name="regioncolor" class="form-control" disabled>
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="vechilenumber" name="vechilenumber" class="form-control col-md-7 col-xs-12" maxlength="50" minlength="3" value="<?php echo (isset($list->vechilenumber)) ? $list->vechilenumber : ""; ?>">
                                            </div>
                                        </div> 
                                    </div>                                   
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="vechilename" name="vechilename" class="form-control col-md-7 col-xs-12" maxlength="50" minlength="3" value="<?php echo (isset($list->vechilename)) ? $list->vechilename : ""; ?>">
                                            </div>
                                        </div> 
                                    </div>                
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="vechilemanufectureyear" name="vechilemanufectureyear" class="form-control col-md-7 col-xs-12" maxlength="100" minlength="3" value="<?php echo (isset($list->vechilemanufectureyear)) ? $list->vechilemanufectureyear : ""; ?>">
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="vechilemodelyear" name="vechilemodelyear" class="form-control col-md-7 col-xs-12" maxlength="4" minlength="4" value="<?php echo (isset($list->vechilemodelyear)) ? $list->vechilemodelyear : ""; ?>">
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="vechilechessisno" name="vechilechessisno" class="form-control col-md-7 col-xs-12" maxlength="30" minlength="3" value="<?php echo (isset($list->vechilechessisno) && !empty($list->vechilechessisno)) ? $list->vechilechessisno : ""; ?>">
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="vechileinsurenceno" name="vechileinsurenceno" class="form-control col-md-7 col-xs-12" maxlength="50" minlength="3" value="<?php echo (isset($list->vechileinsurenceno)) ? $list->vechileinsurenceno : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                                                    <input id="vechileinsurensestartdate" name="vechileinsurensestartdate" class="form-control" disabled type="text" data-required="true" value="<?php echo (isset($list->vechileinsurensestartdate)) ? $list->vechileinsurensestartdate : ""; ?>">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>                                            
                                            </div>                                            
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                                                    <input id="vechileinsurenseduedate" name="vechileinsurenseduedate" class="form-control" disabled type="text" data-required="true" value="<?php echo (isset($list->vechileinsurenseduedate)) ? $list->vechileinsurenseduedate : ""; ?>">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>                                            
                                            </div>                                            
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input disabled type="text" id="vechileenginetype" name="vechileenginetype" class="form-control col-md-7 col-xs-12" maxlength="50" minlength="3" value="<?php echo (isset($list->vechileenginetype)) ? $list->vechileenginetype : ""; ?>">
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="number" id="originalloanamount" name="originalloanamount" class="form-control col-md-7 col-xs-12 allownumericwithdecimal" value="<?php echo (isset($list->originalloanamount)) ? number_format($list->originalloanamount, 2, '.', '') : ""; ?>">
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="loanperiod" name="loanperiod" class="form-control col-md-7 col-xs-12 allownumericwithdecimal" maxlength="50" minlength="1" value="<?php echo (isset($list->loanperiod)) ? $list->loanperiod : ""; ?>">
                                            </div>
                                        </div>  
                                    </div> 
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="number" id="emiamount" name="emiamount" class="form-control col-md-7 col-xs-12 allownumericwithdecimal" maxlength="50" minlength="1" value="<?php echo (isset($list->emiamount)) ? number_format($list->emiamount, 2, '.', '') : ""; ?>">
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <select disabled id="fk_employee_id" name="fk_employee_id" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="commission" name="commission" class="form-control col-md-7 col-xs-12" value="<?php echo (isset($list->commission)) ? $list->commission : "0"; ?>">
                                            </div>
                                        </div> 
                                    </div>  
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="number" id="document_charge" name="document_charge" class="form-control col-md-7 col-xs-12 allownumericwithdecimal" maxlength="50" minlength="1" value="<?php echo (isset($list->document_charge)) ? number_format($list->document_charge, 2, '.', '') : number_format($document_charge, 2, '.', ''); ?>">
                                            </div>
                                        </div>  
                                    </div>  
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="requestdate">HP Date 
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                                                    <input id="requestdate" name="requestdate" class="form-control" disabled type="text" data-required="true" value="<?php echo (isset($list->requestdate)) ? $list->requestdate : ""; ?>">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                            </div>
                                        </div> 
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="security1name" name="security1name" class="form-control col-md-7 col-xs-12" maxlength="100" minlength="3" value="<?php echo (isset($list->security1name)) ? $list->security1name : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="security1aadhar" name="security1aadhar" class="form-control col-md-7 col-xs-12" maxlength="30" minlength="3" value="<?php echo (isset($list->security1aadhar) && !empty($list->security1aadhar)) ? $list->security1aadhar : ""; ?>">
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 elVal">
                                                <input disabled type="text" id="security1mobileno" name="security1mobileno" class="form-control col-md-7 col-xs-12" maxlength="10" minlength="10" value="<?php echo (isset($list->security1mobileno)) ? $list->security1mobileno : ""; ?>">
                                            </div>
                                        </div> 
                                    </div> 

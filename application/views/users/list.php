                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        ...
                        <div class="portlet-header">
                            ...
                            <a href="<?php echo base_url('users/add'); ?>" class="btn btn-secondary pull-right">Add User</a>
                                ...
                                <table 
                                    ...
                                    <thead>
                                        <tr>                                            
                                            ...
                                            <th data-direction="asc" data-filterable="true" data-sortable="true">User Group</th>                                                                                     
                                            <th data-filterable="true" data-sortable="true">Employee</th>                                                                                        
                                            <th>Status</th>                                           
                                            <th>Action</th>                                           
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($list as $key => $value) { ?>
                                            <tr>                                           
                                                ...
                                                <td><?php echo (isset($value->fk_usergroups_groupname)) ? $value->fk_usergroups_groupname : ""; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="javascript:void(0);" class="btn btn-default btn-sm usersview" data-id="<?php echo (isset($value->ecodeid)) ? $value->ecodeid : 0; ?>"><i class="fa fa-eye"></i></a>
                                                        <a href="<?php echo base_url('users/add/' . $value->ecodeid); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                        <a href="javascript:void(0);" class="btn btn-danger btn-sm usersdelete" data-id="<?php echo (isset($value->ecodeid)) ? $value->ecodeid : 0; ?>"><i class="fa fa-times"></i></a>                                                            
                                                    </div>
                                            </tr>                                             
                                        <?php } ?>
                                    </tbody>
